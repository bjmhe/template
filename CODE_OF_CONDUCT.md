...
当事件发生时，及时报告非常重要。要报告可能的违规行为，请通过**维护者在仓库 README 或 GitHub 个人资料中公布的联系方式**与我们联系（与 [安全策略](./SECURITY.md) 中的联系渠道可相同，但请区分「行为准则违规」与「安全漏洞」两类事项）。
...
| 文档                          | 说明                                              |
| ----------------------------- | ------------------------------------------------- |
| [贡献指南](./CONTRIBUTING.md) | 如何参与本仓库的开发与协作                        |
| [安全策略](./SECURITY.md)     | 漏洞的私密报告渠道（**请勿**在公开 Issue 中讨论） |
